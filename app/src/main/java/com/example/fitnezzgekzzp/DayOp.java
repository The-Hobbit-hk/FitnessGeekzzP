...
public class DayOp extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_day_op);
        ...
        weekdaysSpinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (selectedItem.equals("Monday")) {
                    Intent intent = new Intent(DayOp.this, monday.class);
                    startActivity(intent);
                } else if (selectedItem.equals("Tuesday")) {
                    Intent intent = new Intent(DayOp.this, tuesday.class);
                    startActivity(intent);
                } else if (selectedItem.equals("Wednesday")) {
                    Intent intent = new Intent(DayOp.this, wednesday.class);
                    startActivity(intent);
                } else if (selectedItem.equals("Thursday")){
                    Intent intent = new Intent(DayOp.this,thursday.class);
                    startActivity(intent);
                } else if (selectedItem.equals("Friday")){
                    Intent intent = new Intent(DayOp.this,Friday.class);
                    startActivity(intent);
                } else if (selectedItem.equals("Saturday")){
                    Intent intent = new Intent(DayOp.this,saturday.class);
                    startActivity(intent);
                }
            }
